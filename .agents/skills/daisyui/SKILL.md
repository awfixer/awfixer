...
<!-- Image overlay card -->
<div class="card card-compact image-full bg-base-100 w-96 shadow-xl">
  <figure><img src="image.jpg" alt="Album" /></figure>
  <div class="card-body">
...
<dialog id="my_modal_2" class="modal">
  <div class="modal-box">
    <h3 class="text-lg font-bold">Modal with backdrop</h3>
...
<dialog id="my_modal_3" class="modal modal-bottom sm:modal-middle">
  <div class="modal-box">
    <h3 class="text-lg font-bold">Responsive</h3>
...
<div class="stack">
  <div class="card text-primary-content bg-primary shadow-md">
    <div class="card-body">A</div>
  </div>
  <div class="card text-primary-content bg-primary shadow">
    <div class="card-body">B</div>
  </div>
  <div class="card text-primary-content bg-primary shadow-sm">
...
<button
  class="btn btn-primary rounded-full shadow-lg transition-all hover:shadow-xl"
>
  Styled button
</button>
