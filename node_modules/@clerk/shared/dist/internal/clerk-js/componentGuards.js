...
const disabledSelfServeDirectorySyncFeature = (clerk, environment) => {
	return disabledSelfServeSSOFeature(clerk, environment) || !environment?.userSettings.enterpriseSSO.self_serve_directory_sync;
};
...
exports.disabledSelfServeDirectorySyncFeature = disabledSelfServeDirectorySyncFeature;
