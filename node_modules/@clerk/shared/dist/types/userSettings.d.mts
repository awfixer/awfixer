...
type EnterpriseSSOSettings = {
  enabled: boolean;
  self_serve_sso: boolean; /** Whether end-users may manage Directory Sync for their enterprise connections. */
...
//#endregion
export { Actions, AttackProtectionData, Attribute, AttributeData, AttributeDataJSON, Attributes, AttributesJSON, EnterpriseSSOSettings, OAuthProviderSettings, OAuthProviders, PasskeySettingsData, PasswordSettingsData, SignInData, SignUpData, SignUpModes, UserSettingsJSON, UserSettingsResource, UsernameSettingsData, VerificationStrategy };
//# sourceMappingURL=userSettings.d.mts.map