...
type PrepareAffiliationVerificationParams = {
  /** The email address, belonging to the domain, that the verification code is sent to. */affiliationEmailAddress: string;
};
/** @generateWithEmptyComment */
type AttemptAffiliationVerificationParams = {
  /** The verification code that was sent to the affiliation email address. */code: string;
};
/** @generateWithEmptyComment */
...
//# sourceMappingURL=organizationDomain.d.mts.map