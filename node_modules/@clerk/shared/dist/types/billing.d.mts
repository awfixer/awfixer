...
interface BillingInitializedPaymentMethodResource extends ClerkResource {
  ...
  /**
   * The order the payment methods will be displayed in when [`<PaymentElement/>`](/docs/nextjs/reference/hooks/use-payment-element#paymentelement) renders.
   */
...
//# sourceMappingURL=billing.d.mts.map