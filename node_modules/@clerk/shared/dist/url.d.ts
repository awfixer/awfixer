...
declare const createDynamicParamParser: ({
  regex
}: {
  regex: RegExp;
...
declare const populateParamFromObject: <T extends Record<any, any>>({
  urlWithParam,
  entity
}: {
  urlWithParam: string;
