...
const require_error = require('../_chunks/error-DusVHo0B.js');
...
function useOAuthConsent(params) {
	...
	clerk.telemetry?.record(require_telemetry.eventMethodCalled(HOOK_NAME$5));
	...
	const query = useClerkQuery({
		...
		queryFn: async () => {
			...
			try {
				...
				if (require_error.isClerkAPIResponseError(err) && err.status === 404) return null;
				throw err;
			}
		},
		enabled: queryEnabled
...
function useOrganizationEnterpriseConnectionTestRuns(params) {
	...
	const queryEnabled = enabled && clerk.loaded && Boolean(organization) && Boolean(enterpriseConnectionId);
	const [pollingConnectionId, setPollingConnectionId] = (0, react.useState)(null);
...
exports.__internal_useOrganizationDirectorySync = useOrganizationDirectorySync;
exports.__internal_useOrganizationDirectorySyncUsers = useOrganizationDirectorySyncUsers;
...
exports.__internal_useOrganizationSSOBypassAllowlist = useOrganizationSSOBypassAllowlist;
