...
var seedSchema = z5.object({
  ...
  elements: z5.record(
    ...
    z5.object({
      ...
      slots: z5.record(z5.string(), z5.array(z5.string())).optional(),
      on: z5.record(z5.string(), z5.unknown()).optional(),
      visible: z5.unknown().optional()
    }).strict()
  ),
...
var compositionActionSchema = ActionBindingSchema.extend({
  ...
  onSuccess: z6.unknown().optional(),
  onError: z6.unknown().optional()
}).strict();
...
var probability = z7.number().min(0).max(1);
var responseSchema = z7.object({
  answers: z7.record(
    z7.string(),
    z7.object({ type: z7.literal("choice"), choice: z7.string() })
  ),
  providerMetadata: z7.object({
    typesafe: z7.object({ confidence: z7.record(z7.string(), probability) }).optional()
  }).optional(),
  usage: z7.object({ inputTokens: z7.number().int().nonnegative().optional() }).optional()
});
